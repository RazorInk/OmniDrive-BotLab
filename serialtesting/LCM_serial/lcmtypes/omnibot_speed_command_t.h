...
#ifndef _omnibot_speed_command_t_h
#define _omnibot_speed_command_t_h
...
/**
 * Create a deep copy of a omnibot_speed_command_t.
 * When no longer needed, destroy it with omnibot_speed_command_t_destroy()
 */
omnibot_speed_command_t* omnibot_speed_command_t_copy(const omnibot_speed_command_t* to_copy);

/**
 * Destroy an instance of omnibot_speed_command_t created by omnibot_speed_command_t_copy()
 */
void omnibot_speed_command_t_destroy(omnibot_speed_command_t* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _omnibot_speed_command_t_subscription_t omnibot_speed_command_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * omnibot_speed_command_t is received.
 */
typedef void(*omnibot_speed_command_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const omnibot_speed_command_t *msg, void *userdata);

/**
 * Publish a message of type omnibot_speed_command_t using LCM.
 *
 ...
 */
int omnibot_speed_command_t_publish(lcm_t *lcm, const char *channel, const omnibot_speed_command_t *msg);

/**
 * Subscribe to messages of type omnibot_speed_command_t using LCM.
 *
 ...
 */
omnibot_speed_command_t_subscription_t* omnibot_speed_command_t_subscribe(lcm_t *lcm, const char *channel, omnibot_speed_command_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by omnibot_speed_command_t_subscribe()
 */
...
/**
 * Encode a message of type omnibot_speed_command_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to omnibot_speed_command_t_encoded_size().
...
/**
 * Decode a message of type omnibot_speed_command_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with omnibot_speed_command_t_decode_cleanup().
 *
 ...
 */
int omnibot_speed_command_t_decode(const void *buf, int offset, int maxlen, omnibot_speed_command_t *msg);

/**
 * Release resources allocated by omnibot_speed_command_t_decode()
 * @return 0
 */
int omnibot_speed_command_t_decode_cleanup(omnibot_speed_command_t *p);

/**
 * Check how many bytes are required to encode a message of type omnibot_speed_command_t
 */
